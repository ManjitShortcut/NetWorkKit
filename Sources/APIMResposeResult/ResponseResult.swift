 ...
 */
public protocol ResponseResultOutPutProtocol {
...
extension ResponseResult: ResponseResultOutPutProtocol {
     ...
     */
   public func isResponseResultSuccess() -> Bool {
     ...
     */
   public fileprivate func isConnectionSuccess() -> Bool {
     ...
     */
   public func getResponseResult<T>() -> T? {
        return result as? T
    }
     ...
     */
    public func getWebServiceResponseStatus() -> WebServiceResponseStatus {
        if isHttpsSuccess() {
            if result != nil {
